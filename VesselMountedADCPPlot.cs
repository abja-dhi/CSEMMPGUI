...
namespace CSEMMPGUI_v1
{
    public partial class VesselMountedADCPPlot : Form
    {
        ...
        public VesselMountedADCPPlot(string? id)
        {
            InitializeComponent();
            InitializeWidgets();
            comboPlotType.SelectedIndex = 0;
            adcp = _project.GetObject(type: "VesselMountedADCP", id: id);
            survey = _project.GetParent(type: "VesselMountedADCP", id: id);
        }

        private void btnPlot_Click(object sender, EventArgs e)
        {
            XmlElement? waterProp = survey.SelectSingleNode("//Water") as XmlElement;
            XmlElement? sedimentProp = survey.SelectSingleNode("//Sediment") as XmlElement;
