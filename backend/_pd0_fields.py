...
class Pd0Formats:
    ...
    bottom_track: List[FieldDef] = [
        ...
        FieldDef("BEAM#1 BT %GOOD", 1, "<", "B", True),
        FieldDef("BEAM#2 BT %GOOD", 1, "<", "B", True),
        FieldDef("BEAM#3 BT %GOOD", 1, "<", "B", True),
        FieldDef("BEAM#4 BT %GOOD", 1, "<", "B", True),
        ...
        FieldDef("BM#1 REF %GOOD", 1, "<", "B", True),
        FieldDef("BM#2 REF %GOOD", 1, "<", "B", True),
        FieldDef("BM#3 REF %GOOD", 1, "<", "B", True),
        FieldDef("BM#4 REF %GOOD", 1, "<", "B", True),
